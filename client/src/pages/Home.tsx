      ...
      {!showIntro && <>
        ...
        <main id="home">
          <section className="home-hero" aria-labelledby="home-hero-title">
            ...
            <aside className="hero-evidence-strip" aria-label="Verified ChipTech event record"><span>PROOF LEDGER</span><strong>Circuitrix: Light Up RVU</strong><time dateTime="2023-12-20">20 DEC 2023</time><a href="https://rvu.edu.in/events/circuitrix-light-up-rvu/" target="_blank" rel="noreferrer">View RVU record <ArrowUpRight size={14} /></a></aside>
